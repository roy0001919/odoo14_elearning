...
class HrEmployeePrivate(models.Model):
    ...
    def read(self, fields, load='_classic_read'):
        try:
            # for r in self:
            #     url = "https://simplybook.asia/uploads/smarterspa/image_files/preview/dd265313cf3c90d31f4c1a0122b88b89.jpg"
            #     res = requests.get(url)
            #     print(r.name)
            #     r.image_128 = base64.b64encode(res.content)
            #     r.image_1920 = base64.b64encode(res.content)
            if self.check_access_rights('read', raise_exception=False):
