...
class Partner(models.Model):
    ...
    @api.multi
    def google_map_img(self, zoom=12, width=298, height=298):
        ...
        params = {
            ...
            'markers': '%s, %s %s, %s' % (self.street or '', self.city or '', self.zip or '', self.country_id and self.country_id.name_get()[0][1] or ''),
