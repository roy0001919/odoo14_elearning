...
odoo.define('booking_calendar.booking_calendar', function (require) {
    "use strict";
    ...
    // var SidebarFilter = require('web_calendar.SidebarFilter');
    var SLOT_START_DELAY_MINS = 30; //minutes
    var SLOT_MINUTES = 30; //minutes
    ...
    CalendarView.include({
        ...
        read_resource_color: function(key) {
            ...
            if (key in this.color_code_map) {
                ...
                new Model(this.model).call('read_color', [key]).then(function(result) {
        ...
        //     if (this.free_slots) {
        //         var self = this;
        //         // this.quick.on("form_view_loaded", this, function() {
        //             var $sbutton = $(".o_formdialog_save");
        //             var $sobutton = $(_t("<button class='btn btn-sm oe_button btn-primary o_formdialog_save'>Save & Open SO</button>"));
        //             $sbutton.after($sobutton);
        //             $sobutton.click(function() {
        //                 $.when($sbutton.click()).done(function(line_id) {
        //                     // self.quick.reload_mutex.exec(function() {
        //                     //     self.check_exit();
