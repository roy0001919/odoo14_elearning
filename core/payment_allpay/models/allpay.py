...
from core.payment_allpay.controllers.main import allPayController
...
class AcquirerallPay(models.Model):
    ...
    def _get_allpay_urls(self, cr, uid, environment, context=None):
        ...
        if environment == 'prod':
            return {
                'allpay_url': 'https://payment.allpay.com.tw/Cashier/AioCheckOut/V2'
            }
        else:
            return {
                'allpay_url': 'https://payment-stage.allpay.com.tw/Cashier/AioCheckOut/V2'
            }
    ...
    provider = fields.Selection(selection_add=[('allpay', 'Allpay')])
