...
odoo.define('web_widget_x2many_2d_matrix.widget', function (require) {
    ...
    var WidgetX2Many2dMatrix = FieldOne2Many.extend({
        ...
        init: function(field_manager, node)
        {
            ...
            this.field_extra_y_axis = node.attrs.field_extra_y_axis || '';
        ...
        set_value: function(value_)
        {
            ...
            return $.when(result).then(function()
            {
                ...
                {
                    self.fields = fields;
                    self.is_numeric = ['float', 'integer'].indexOf(fields[self.field_value].type) != -1;
        ...
        get_heading_x_axis_labels: function()
        {
            if (this.field_extra_y_axis == '')
                return [];
            var s = this.field_extra_y_axis.split(',');
            return s;
        },
