...
class PrintLiouliBridgeReport(models.TransientModel):
	_name = 'biznavi_ticket.report'
	_description = 'Print LiouliBridge Report'
	...
	def print_report(self):
		...
		return {
			...
			'url': '/biznavi_ticket/report?d=%s&filename=report_%s.xls' % (self.report_date, self.report_date),
			'target': 'new',
		}
